...
/**
 * PatientRating entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class PatientRating implements java.io.Serializable {
	...
	/** default constructor */
	public PatientRating() {
	}

	/** full constructor */
	public PatientRating(String description, Short active, Short defaultCode,
			Set patients) {
