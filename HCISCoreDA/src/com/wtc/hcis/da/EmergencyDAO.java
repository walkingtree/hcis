 ...
 * 
 * @see com.wtc.hcis.da.Emergency
 * @author MyEclipse Persistence Tools
 */

public class EmergencyDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(EmergencyDAO.class);
	// property constants
	...
	public Emergency findById(java.lang.String id) {
		...
		try {
			Emergency instance = (Emergency) getHibernateTemplate().get(
					"com.wtc.hcis.da.Emergency", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Emergency instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Emergency as model where model."
					+ propertyName + "= ?";
	...
	public Emergency merge(Emergency detachedInstance) {
		...
		try {
			Emergency result = (Emergency) getHibernateTemplate().merge(
					detachedInstance);
